...
<html>
  ...
  <body>
    <center>
      <h1>Control Aro RGB</h1>
      <h3>Imprimiendo</h3>
      <div id="botonImprimiendo" class="vivo">
        <span class="pollo">
      ...
      <h3>Telegram</h3>
      <div id="botonTelegram" class="vivo">
        <span class="pollo">
          <span class="huevo"></span>
        </span>
      </div>
    ...
    <script>
      ...
      const elementoEstado = document.getElementById("botonImprimiendo");
      ...
      const elementoTelegram = document.getElementById("botonTelegram");
      ...
      elementoTelegram.addEventListener("click", cambiarTelegram);
      ...
      function cambiarTelegram(){
        const elementoEstado = document.getElementById("botonTelegram");
        ...
        console.log("Cambiando Telegram a " + elementoEstado.className)
        consultaGET("http://%ip/telegram?estado=" + elementoEstado.className);
      }
